...
import numpy as np
column = "labels"
filepath = "/mnt/ds3lab-scratch/yidai/nwp_subsampled_2x2_5_day_stride_ensemble_7quantiles/2018_with_labels" 
...
#new_df_00["lat_lon_id"] = [dict[(init_time_00["lat_1"][i], init_time_00["lon_1"][i])] for i in range(0, init_time_00.shape[0])]
#new_df_12["lat_lon_id"] = [dict[(init_time_12["lat_1"][i], init_time_12["lon_1"][i])] for i in range(0, init_time_12.shape[0])]
...
full_data.to_pickle("/mnt/ds3lab-scratch/yidai/input_to_tf_q7lb_init_time.pkl")
