...
class DataGenerator:
    def __init__(self, config, comet_logger):
        ...
        labels = xr.open_mfdataset(
            "/mnt/ds3lab-scratch/bhendj/grids/CM-SAF/MeteosatCFC/meteosat.CFC.H_ch05.latitude_longitude_20140[2-3]*.nc",
        ...
        cutoff_date = pd.Timestamp('2014-04-01') - pd.Timedelta(hours=121)
        ...
        #    except ValueError:
        #        break
        nwp_train = nwp.sel(init_time=slice('2014-02-01','2014-03-01'))
        nwp_val = nwp.sel(init_time=slice('2014-03-01','2014-03-31'))
