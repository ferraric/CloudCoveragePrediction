...
from data_loader.context_dataset import ContextDataset
...
class DataGenerator:
    def __init__(self, config, comet_logger):
        ...
        train_values_context = train_values_context[~nan_indices, :]
        train_x = np.stack([train_values_mean_correct_shape, train_values_var_correct_shape], axis=-1)
        ...
        self.train_data = ContextDataset(train_values_context, train_x, train_labels_correct_shape, self.config.batch_size)
        ...
        val_values_win_context = val_values_win_context[~nan_indices, :]
        val_win_x = np.stack([val_values_win_mean_correct_shape, val_values_win_var_correct_shape], axis=-1)
        ...
        self.validation_data_win = ContextDataset(val_values_win_context, val_win_x, val_labels_win_correct_shape,
        ...
        val_values_spr_context = val_values_spr_context[~nan_indices, :]
        val_spr_x = np.stack([val_values_spr_mean_correct_shape, val_values_spr_var_correct_shape], axis=-1)
        ...
        self.validation_data_spr = ContextDataset(val_values_spr_context, val_spr_x, val_labels_spr_correct_shape,
                                                  self.config.batch_size)
        ...
        val_values_sum_context = val_values_sum_context[~nan_indices, :]
        val_sum_x = np.stack([val_values_sum_mean_correct_shape, val_values_sum_var_correct_shape], axis=-1)
        ...
        self.comet_logger.log_other("validation size summer after removing nan",
                                    val_values_sum_mean_correct_shape.shape)
        self.validation_data_sum = ContextDataset(val_values_sum_context, val_sum_x, val_labels_sum_correct_shape,
                                                  self.config.batch_size)
        ...
        val_values_fal_context = val_values_fal_context[~nan_indices, :]
        val_fal_x = np.stack([val_values_fal_mean_correct_shape, val_values_fal_var_correct_shape], axis=-1)
        ...
        self.comet_logger.log_other("validation size fall after removing nan",
                                    val_values_fal_mean_correct_shape.shape)
        self.validation_data_fal = ContextDataset(val_values_fal_context, val_fal_x, val_labels_fal_correct_shape,
                                                  self.config.batch_size)
