...
from models.context_unet_model import ContextUNetModel
from data_loader.context_unet_data_loader import DataGenerator
...
def main():
    ...
    dummy_model = ContextUNetModel(config)
