...
from data_loader.quantiles_data_loader import DataGenerator
...
from models.unet_model_quantiles import UNetModelQ
from trainers.example_trainer import ExampleTrainer
from trainers.quantiles_trainer import QuantilesTrainer
...
def main():
    ...
    model = UNetModelQ(config)
    trainer = QuantilesTrainer(model, data, config, experiment)
    trainer.train()
