...
class CRPSTrainer(BaseTrain):
    ...
    def setup_metrics(self):
        ...
        self.validation_pit_hist_spr= PitHistNorm(name="validation_pit_hist_spr")
        self.validation_pit_hist_sum = PitHistNorm(name="validation_pit_hist_sum")
        self.validation_pit_hist_fal = PitHistNorm(name="validation_pit_hist_fal")
