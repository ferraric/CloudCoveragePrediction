...
def take_ensemble_quantiles(
    ...
    data = data.expand_dims('quantile',
                            axis=1).assign_coords(quantile=range(no_quantiles))
    data = data.assign(CLCT_quantiles=(['lead_time', 'quantile', 'y_1', 'x_1'],
                                       quantile_values))
    return data
