...
for year in [2014, 2016, 2017, 2018, 2019]:
    for month in range(1, 13, 1):
        for day_range in range(0, 4, 1):
            ...
            print(
                np.count_nonzero(predictions.CLCT.values < 0) /
                total_number_of_values)
            print("percentage of clct > 100: ")
            print(
                np.count_nonzero(predictions.CLCT.values > 100) /
                total_number_of_values)
            print("max clct: ")
